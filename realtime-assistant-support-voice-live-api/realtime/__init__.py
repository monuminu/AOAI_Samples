...
class RealtimeAPI(RealtimeEventHandler):
    def __init__(self):
        super().__init__()
        self.url= os.environ.get("AZURE_VOICE_LIVE_ENDPOINT") or "https://your-endpoint.azure.com/"
        self.model = os.environ.get("VOICE_LIVE_MODEL") or "gpt-4o"
        self.api_version = os.environ.get("AZURE_VOICE_LIVE_API_VERSION") or "2025-05-01-preview"
        self.api_key = os.environ.get("AZURE_VOICE_LIVE_API_KEY") or "your_api_key"
        self.ws = None
    ...
    async def connect(self):
        ...
        self.ws = await websockets.connect(f"{self.url}/voice-agent/realtime?api-version={self.api_version}&model={self.model}&api-key={self.api_key}")
